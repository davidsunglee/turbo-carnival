...
struct GameTimeTests {
    ...
    @Test func gameConfigHasGameplayConstants() {
        ...
        #expect(GameConfig.Player.fireRate == 4.0)
        #expect(GameConfig.Player.projectileSpeed == Float(500))
        #expect(GameConfig.Enemy.tier1HP == Float(2))
        #expect(GameConfig.Enemy.tier2HP == Float(4))
        #expect(GameConfig.Enemy.tier3TurretHP == Float(6))
        #expect(GameConfig.Enemy.bossHP == Float(60))
